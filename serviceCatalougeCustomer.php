	...
	<div class="slider">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav class="cl-effect-1" id="cl-effect-1">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="serviceCatalougeCustomer.php" data-hover="Home">Services Catalogue</a></li>
		...
		<div class="container">
	        ...
	        <div class="contact-middle" align="center" style="background:rgba(0, 0, 0, 0.8);">
				...
				<h3 style="color:#ffa500;">Services Catalouge</h3><br>
					...
					<table class="table" id="example1" style="color:white; !important">
						<thead>
						  <tr>
							...
							<th><p>Type</p></th>
							<th><p>Quantity</p></th>
							<th><p>Add to Basket</p></th>
						  </tr>
						</thead>
						<tbody>
						 
						 <?php getServicesCatalogue();?>
						
						</tbody>
					</table>
				</div>
				
				<!--<a href="customer.php"><button class="btn btn-success"> Request Quote </button> </a> -->
			</div>
			<!-- table 1-->
			<br><br><br>
...
<?php
	...
	// when user clicks on add on basket button
	if(isset($_POST['targetItemToBasket'])){
		addItemToBasket($_POST['targetItemToBasket'],$_POST['targetItemToBasketQuantity']);
	}
